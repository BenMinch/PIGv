...
score_dict = {"MirusDNAB":float(50),"MirusMCP":float(40),"MirusRNAa":float(50),"MirusRNAb":float(50),"MirusTFIIS":float(50)}
...
def main(argv=None):
	...
	args_parser.add_argument('-m', '--markerset', required=False, help='Markers to use. Must be comma-separated list of the following: MirusMCP, MirusDNAB, MirusRNAa, MirusRNAb, MirusTFIIS (default=MirusMCP,MirusDNAB,MirusRNAa,MirusRNAb,MirusTFIIS)')
